...
from m300_toolbox.files.getfilecount import get_file_count
...
class TestGetFileCount(TestCase):
  ...
  @patch('m300_toolbox.http.httputil._get_http_response', _GET_HTTP_RESPONSE_MAGIC_MOCK_1)
  ...
  @patch('m300_toolbox.http.httputil._get_http_response', _GET_HTTP_RESPONSE_MAGIC_MOCK_2)
